...
const true_start_classies = {
  ...
  scene: "w-3/5 h-fit my-10 p-2 text-teal-900 bg-teal-100/90 flex flex-col outline outline-offset-4 outline-2 outline-teal-200 self-center text-2xl rounded-md z-20",
  story: "text-2xl z-20",
...
const start_classies = {
  state: "start",
  appies: "h-dvh w-screen bg-teal-300 bodyfont flex flex-col justify-center items-center z-0",
  scene: "w-3/4 md:w-2/5 xl:w-1/5 h-fit text-teal-900 bg-teal-100/90 flex flex-col outline outline-offset-4 outline-2 outline-teal-200 self-center text-2xl rounded-md z-20",
  story: "text-2xl z-20",
...
const bulletin_classies = {
  ...
  story: "text-2xl z-20",
  choices: "text-xl z-20 text-center text-teal-900 hover:text-teal-700 hover:cursor-pointer hover:tracking-wider w-fit mx-auto py-0.5 mt-4 px-3 outline outline-offset-2 outline-1 hover:outline-2 hover:outline-offset-4 outline-teal-500/50 hover:outline-teal-500/90 rounded-2xl bg-white/80",
  ending: "hidden"
}
